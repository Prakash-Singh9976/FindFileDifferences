...
public class FileDiff {
	...
	public static void main(String[] args) throws IOException {
		...
		LineIterator file1 = FileUtils.lineIterator(new File("C:/Users/Admin/Documents/eclipse-workspace/file1.txt"), "utf-8");
		LineIterator file2 = FileUtils.lineIterator(new File("C:/Users/Admin/Documents/eclipse-workspace/file2.txt"), "utf-8");
...
class FileCommandsVisitor implements CommandVisitor<Character> {
	...
	public void generateHTML() throws IOException {
		...
		// comparison
		String template = FileUtils.readFileToString(new File("C:/Users/Admin/Documents/eclipse-workspace/difftemplate.html"), "utf-8");
		String out1 = template.replace("${left}", left);
		String output = out1.replace("${right}", right);
		// Write file to disk.
		FileUtils.write(new File("C:/Users/Admin/Documents/eclipse-workspace/finalDiff.html"), output, "utf-8");
